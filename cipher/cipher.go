...
/*
 * EncryptWriter returns a writer that will write encrypted data to
 * the original writer.
 */
...
/*
 * DecryptWriter returns a reader that will decrypt data from
 * the provided reader and read it.
 */
